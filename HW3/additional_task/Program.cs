...
while (true) {
    ...
    if (N <= 0) {
        ...
        if (head_count == tail_count) {
            ...
            System.Console.WriteLine(
                $"Чтобы все монетки были повернуты вверх одной и той же стороной, минимальное количество монет, которые необходимо перевернуть - {head_count}, лежащих вверх орлом.");
        } else {
            System.Console.WriteLine(
                $"Чтобы все монетки были повернуты вверх одной и той же стороной, минимальное количество монет, которые необходимо перевернуть - {tail_count}, лежащих вверх решкой.");
        }
        break;
    }
}
